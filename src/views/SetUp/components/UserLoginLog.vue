      ...
      <div id="System-main-header">
        <el-row type="flex" class="row-bg" justify="space-between">
          ...
          <el-col :span="7" id="col2">
            ...
            <el-row :gutter="20">
              <el-col :span="7" style="text-align: right"> 创建时间选择：</el-col>
              <el-col :span="8">
                <div class="container">
                  <div class="block">
                    <el-date-picker
      ...
      <div class="System-main-main">
        ...
        >
          ...
          <el-table-column label="发生时间" align='center' show-overflow-tooltip>
            <template slot-scope="scope">{{ scope.row.loadTime}}</template>
          </el-table-column>
          ...
          <el-table-column label="登录IP" align='center' show-overflow-tooltip>
            <template slot-scope="scope">{{ scope.row.loadIp}}</template>
          </el-table-column>
          <el-table-column label="日志详情" align='center' show-overflow-tooltip>
    ...
    methods: {
      ...
      export2Excel() {
        ...
        require.ensure([], () => {
          ...
          const tHeader = ['发生时间', '用户', '用户ID', '登录IP', '日志详情']; // 导出的表头名
          const filterVal = ['loadTime', 'userName', 'userId', 'loadIp', 'remarks',]; // 导出的表头字段名
          const list = that.excelData;
          const data = that.formatJson(filterVal, list);
          export_json_to_excel(tHeader, data, `用户登录日志`);// 导出的表格名称，根据需要自己命名
        })
      },
