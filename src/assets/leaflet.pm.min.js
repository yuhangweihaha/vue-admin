!function (t) {
  ...
  "use strict";
  var r = n(10), i = n(35), o = L.Class.extend({
    includes: [i.a, r.a],
    options: {snappable: !0, snapDistance: 20, allowSelfIntersection: !0, draggable: !0},
    isPolygon: function () {
  ...
  var r = n(16), i = n(47), o = "[object Symbol]";
  ...
  var r = n(43), i = "object" == typeof self && self && self.Object === Object && self,
  ...
  var r = n(11), i = {
    _initSnappableMarkers: function () {
      ...
      var e = t.layer, n = this._snapList.findIndex(function (t) {
      ...
      var e, n = this._map, i = t.segment[0], o = t.segment[1], a = t.latlng, s = this._getDistance(n, i, a),
        l = this._getDistance(n, o, a), h = s < l ? i : o, u = s < l ? s : l;
      if (this.options.snapMiddle) {
        var c = r.a.calcMiddleLatLng(n, i, o), p = this._getDistance(n, c, a);
        p < s && p < l && (h = c, u = p)
      }
      return e = u < this.options.snapDistance ? h : a, Object.assign({}, e)
    }, _createSnapList: function () {
      var t = this, e = [], n = [], r = this._map;
      ...
      var n, r, i = this, o = this._map, a = e instanceof L.Marker || e instanceof L.CircleMarker,
        s = e instanceof L.Polygon, l = t, h = a ? e.getLatLng() : e.getLatLngs();
      if (a) return {latlng: Object.assign({}, h), distance: this._getDistance(o, h, l)};
      !function c(t) {
        t.forEach(function (e, a) {
          if (Array.isArray(e)) c(e); else {
            var h, u = e;
      ...
      return {latlng: Object.assign({}, u), segment: n, distance: r}
    }, _getClosestPointOnSegment: function (t, e, n, r) {
      var i = t.getMaxZoom();
      i === Infinity && (i = t.getZoom());
      var o = t.project(e, i), a = t.project(n, i), s = t.project(r, i), l = L.LineUtil.closestPointOnSegment(o, a, s);
      return t.unproject(l, i)
    }, _getDistanceToSegment: function (t, e, n, r) {
      var i = t.latLngToLayerPoint(e), o = t.latLngToLayerPoint(n), a = t.latLngToLayerPoint(r);
  ...
  e.a = {
    calcMiddleLatLng: function (t, e, n) {
      var r = t.project(e), i = t.project(n);
  ...
  e["default"] = function (t) {
    var e, n, o = {type: "FeatureCollection", features: []};
    ...
    return e.forEach(function (t) {
      e.forEach(function (e) {
        for (var n = 0; n < t.length - 1; n++) for (var a = n; a < e.length - 1; a++) {
          if (t === e) {
  ...
  !function (t, n) {
    ...
    n.prototype.rotateLeft = function (t) {
      ...
      var n = this._root, r = null, i = this._compare;
      ...
      } else this.replace(e, e.left); else this.replace(e, e.right);
      return this._size--, !0
    }, n.prototype.removeNode = function (t) {
      if (!t) return !1;
      if (this.splay(t), t.left) if (t.right) {
      ...
      for (var i = [], o = this._compare, a = this._root; 0 !== i.length || a;) if (a) i.push(a), a = a.left; else {
      ...
      return n && function i(t, e, n, r, o) {
        ...
        var a = i - r;
        if (a > 0) {
          var s = r + Math.floor(a / 2), l = e[s], h = n[s], u = {key: l, data: h, parent: t};
    ...
    var i = 0, o = 1, a = 2, s = 3, l = 0, h = 1, u = 2, c = 3;
    ...
    function y(t, e, n) {
      var r = new d(e, !1, t, t.isSubject), i = new d(e, !0, t.otherEvent, t.isSubject);
    ...
    function b(t, e, n) {
      var r = function (t, e, n, r, i) {
        var o = [e[0] - t[0], e[1] - t[1]], a = [r[0] - n[0], r[1] - n[1]];

        function s(t, e, n) {
          return [t[0] + e * n[0], t[1] + e * n[1]]
        }

        var l = [n[0] - t[0], n[1] - t[1]], h = v(o, a), u = h * h, c = L(o, o);
        if (u > 0) {
          var p = v(l, a) / h;
        ...
        var d = L(o, l) / c, g = d + L(o, a) / c, _ = Math.min(d, g), m = Math.max(d, g);
        return _ <= 1 && m >= 0 ? 1 === _ ? i ? null : [s(t, _ > 0 ? _ : 0, o)] : 0 === m ? i ? null : [s(t, m < 1 ? m : 1, o)] : i && 0 === _ && 1 === m ? null : [s(t, _ > 0 ? _ : 0, o), s(t, m < 1 ? m : 1, o)] : null
      }(t.point, t.otherEvent.point, e.point, e.otherEvent.point), i = r ? r.length : 0;
      if (0 === i) return 0;
    ...
    function w(t, e) {
      var n, r, i, o = function (t) {
        ...
        for (var a = !1; !a;) for (a = !0, n = 0, r = o.length; n < r; n++) n + 1 < r && 1 === m(o[n], o[n + 1]) && (i = o[n], o[n] = o[n + 1], o[n + 1] = i, a = !1);
      ...
      for (n = 0, r = o.length; n < r; n++) if (!a[n]) {
        var l = [[]];
        o[n].isExteriorRing ? e === u && !o[n].isSubject && s.length > 1 ? s[s.length - 1].push(l[0]) : s.push(l) : e !== u || o[n].isSubject || 0 !== s.length ? 0 === s.length ? s.push([[l]]) : s[s.length - 1].push(l[0]) : s.push(l);
        var h = s.length - 1, c = n, p = o[n].point;
    ...
    d.prototype.isBelow = function (t) {
      var e = this.point, n = this.otherEvent.point;
    ...
    function C(t, e) {
      ...
      if (this.data = t || [], this.length = this.data.length, this.compare = e || x, this.length > 0) for (var n = (this.length >> 1) - 1; n >= 0; n--) this._down(n)
    }
    ...
    var P = Math.max, O = Math.min, I = 0;

    function D(t, e, n, r, i, o) {
      var a, s, l, h, u, c;
      for (a = 0, s = t.length - 1; a < s; a++) if (l = t[a], h = t[a + 1], u = new d(l, !1, undefined, e), c = new d(h, !1, u, e), u.otherEvent = c, l[0] !== h[0] || l[1] !== h[1]) {
    ...
    function j(t, e, r) {
      ...
      var i = function (t, e, n) {
        var r = null;
        return t.length * e.length == 0 && (n === l ? r = T : n === u ? r = t : n !== h && n !== c || (r = 0 === t.length ? e : t)), r
      }(t, e, r);
      if (i) return i === T ? null : i;
      var o = [Infinity, Infinity, -Infinity, -Infinity], a = [Infinity, Infinity, -Infinity, -Infinity],
        s = function (t, e, n, r, i) {
          var o, a, s, l, h, c, p = new E(null, m);
          for (s = 0, l = t.length; s < l; s++) for (h = 0, c = (o = t[s]).length; h < c; h++) (a = 0 === h) && I++, D(o[h], !0, I, p, n, a);
          for (s = 0, l = e.length; s < l; s++) for (h = 0, c = (o = e[s]).length; h < c; h++) a = 0 === h, i === u && (a = !1), a && I++, D(o[h], !1, I, p, r, a);
          return p
        }(t, e, o, a, r);
      return (i = function (t, e, n, r, i) {
        var o = null;
        return (n[0] > r[2] || r[0] > n[2] || n[1] > r[3] || r[1] > n[3]) && (i === l ? o = T : i === u ? o = t : i !== h && i !== c || (o = t.concat(e))), o
      }(t, e, o, a, r)) ? i === T ? null : i : w(function (t, e, r, i, o, a) {
    ...
    var R = {UNION: h, DIFFERENCE: u, INTERSECTION: l, XOR: c};
    t.union = function (t, e) {
      ...
      return j(t, e, l)
    }, t.operations = R, Object.defineProperty(t, "__esModule", {value: !0})
  })
}, function (t, e, n) {
  "use strict";
  Object.defineProperty(e, "__esModule", {value: !0});
  ...
  function i(t, e, n) {
    if (null !== t) for (var r, o, a, s, l, h, u, c, p = 0, f = 0, d = t.type, g = "FeatureCollection" === d, _ = "Feature" === d, m = g ? t.features.length : 1, y = 0; y < m; y++) {
  ...
  function s(t, e) {
    var n, r, i, o, a, s, l, h, u, c, p = 0, f = "FeatureCollection" === t.type, d = "Feature" === t.type,
      g = f ? t.features.length : 1;
    for (n = 0; n < g; n++) {
      for (s = f ? t.features[n].geometry : d ? t.geometry : t, h = f ? t.features[n].properties : d ? t.properties : {}, u = f ? t.features[n].bbox : d ? t.bbox : undefined, c = f ? t.features[n].id : d ? t.id : undefined, a = (l = !!s && "GeometryCollection" === s.type) ? s.geometries.length : 1, i = 0; i < a; i++) if (null !== (o = l ? s.geometries[i] : s)) switch (o.type) {
        case"Point":
        case"LineString":
        case"MultiPoint":
        case"Polygon":
        ...
        case"MultiPolygon":
          ...
          break;
        case"GeometryCollection":
          for (r = 0; r < o.geometries.length; r++) if (!1 === e(o.geometries[r], p, h, u, c)) return !1;
          break;
        default:
          throw new Error("Unknown Geometry Type")
  ...
  function l(t, e) {
    s(t, function (t, n, i, o, a) {
      ...
      switch (l) {
        ...
        case"LineString":
        case"Polygon":
          return !1 !== e(r.feature(t, i, {bbox: o, id: a}), n, 0) && void 0
      }
      switch (l) {
        case"MultiPoint":
          s = "Point";
  ...
  function u(t, e) {
    ...
    l(t, function (t, n, i) {
      if (null !== t.geometry) {
        var o = t.geometry.type, a = t.geometry.coordinates;
        switch (o) {
          case"LineString":
            if (!1 === e(t, n, i, 0, 0)) return !1;
            break;
          case"Polygon":
            for (var s = 0; s < a.length; s++) if (!1 === e(r.lineString(a[s], t.properties), n, i, s)) return !1
        }
      }
    })
  }
  ...
  e.coordEach = i, e.coordReduce = function (t, e, n, r) {
    ...
    var n, i = e.featureIndex || 0, o = e.multiFeatureIndex || 0, a = e.geometryIndex || 0, s = e.segmentIndex || 0,
      l = e.properties;
    switch (t.type) {
      case"FeatureCollection":
    ...
    if (e = e || {}, !r.isObject(e)) throw new Error("options is invalid");
    var n, i = e.featureIndex || 0, o = e.multiFeatureIndex || 0, a = e.geometryIndex || 0, s = e.coordIndex || 0,
      l = e.properties;
    switch (t.type) {
      case"FeatureCollection":
        i < 0 && (i = t.features.length + i), l = l || t.features[i].properties, n = t.features[i].geometry;
  ...
  var r = n(8), i = n(45), o = n(46), a = "[object Null]", s = "[object Undefined]", l = r ? r.toStringTag : undefined;
  t.exports = function (t) {
  ...
  "use strict";
  Object.defineProperty(e, "__esModule", {value: !0});
  var r = n(21), i = (n.n(r), n(22)), o = (n.n(i), n(23)), a = n(24), s = n(0),
    l = (n(26), n(27), n(28), n(29), n(30), n(31), n(1)), h = (n(36), n(37), n(38), n(82), n(83), n(84), n(85)),
    u = (n.n(h), n(86));
  n.n(u);
  L.PM = L.PM || {
    Map: o.a, Toolbar: a.a, Draw: s.a, Edit: l.a, version: i.version, initialize: function () {
      this.addInitHooks()
  ...
  t.exports = {
    ...
    dependencies: {"@turf/difference": "^6.0.2", "@turf/intersect": "^6.1.3", "@turf/kinks": "6.x", lodash: "^4.17.11"},
    devDependencies: {
      "@babel/core": "^7.2.2",
    ...
    repository: {type: "git", url: "git+https://github.com/codeofsumit/leaflet.pm.git"},
    author: {name: "Sumit Kumar", email: "sk@outlook.com", url: "http://twitter.com/TweetsOfSumit"},
    license: "MIT",
  ...
  var r = L.Class.extend({
    initialize: function (t) {
      ...
      var e = t.target;
      !(e._pmTempLayer || e.pm && e.pm.dragging()) && (e.remove(), this.map.fire("pm:remove", {layer: e}))
      ...
      }), this.map.on("layeradd", this.layerAddHandler, this), this.Toolbar.toggleButton("dragMode", this._globalDragMode)
    }, disableGlobalDragMode: function () {
      var t = this.findLayers();
      this._globalDragMode = !1, t.forEach(function (t) {
        t.pm.disableLayerDrag()
      }), this.map.off("layeradd", this.layerAddHandler, this), this.Toolbar.toggleButton("dragMode", this._globalDragMode)
      ...
      }), this.map.off("layeradd", this.layerAddHandler, this), this.Toolbar.toggleButton("deleteLayer", this._globalRemovalMode)
    }, enableGlobalRemovalMode: function () {
      var t = this;
      this._globalRemovalMode = !0, this.map.eachLayer(function (e) {
        (function (t) {
          return t.pm && !(t.pm.options && t.pm.options.preventMarkerRemoval)
        })(e) && e.on("click", t.removeLayer, t)
      }), this.map.on("layeradd", this.layerAddHandler, this), this.Toolbar.toggleButton("deleteLayer", this._globalRemovalMode)
      ...
      this.map.fire("pm:globaleditmodetoggled", {enabled: t, map: this.map})
  ...
  var i = L.Class.extend({
    options: {
      ...
      var t = this, e = {
        ...
        afterClick: function () {
          t.map.pm.Draw.Cut.toggle({snappable: !0, cursorMarker: !0, allowSelfIntersection: !1})
        },
        doToggle: !0,
        toggleStatus: !1,
        disableOtherButtons: !0,
      ...
      this._addButton("drawMarker", new L.Control.PMButton(e)), this._addButton("drawPolyline", new L.Control.PMButton(r)), this._addButton("drawRectangle", new L.Control.PMButton(o)), this._addButton("drawPolygon", new L.Control.PMButton(n)), this._addButton("drawCircle", new L.Control.PMButton(i)), this._addButton("editMode", new L.Control.PMButton(a)), this._addButton("dragMode", new L.Control.PMButton(s)), this._addButton("cutPolygon", new L.Control.PMButton(l)), this._addButton("removalMode", new L.Control.PMButton(h))
  ...
  var r = L.Control.extend({
    options: {position: "topleft"}, initialize: function (t) {
      ...
      var e = this, n = L.DomUtil.create("div", "button-container", this._container),
        r = L.DomUtil.create("a", "leaflet-buttons-control-button", n),
        i = L.DomUtil.create("div", "leaflet-pm-actions-container", n), o = {
          cancel: {
            text: "取消", onClick: function () {
              this._triggerClick()
            }
          }, removeLastVertex: {
            // text: "Remove Last Vertex", onClick: function () {
            text: "删除最后一个顶点", onClick: function () {
              this._map.pm.Draw[t.jsClass]._removeLastVertex()
            }
          }, finish: {
            // text: "Finish", onClick: function (e) {
            text: "完成", onClick: function (e) {
              this._map.pm.Draw[t.jsClass]._finishShape(e)
            }
          }
        };
      t.actions.forEach(function (t) {
        var n = o[t], r = L.DomUtil.create("a", "leaflet-pm-action action-".concat(t), i);
  ...
  r.a.Marker = r.a.extend({
    initialize: function (t) {
      ...
      }), this._map.fire("pm:drawend", {shape: this._shape}), this._map.pm.Toolbar.toggleButton(this.toolbarButtonName, !1), this._enabled = !1)
    }, enabled: function () {
      ...
      if (t.latlng) {
        ...
        var e = this._hintMarker.getLatLng(), n = new L.Marker(e, this.options.markerStyle);
  ...
  o.a.Line = o.a.extend({
    initialize: function (t) {
      ...
      this._doesSelfIntersect = r.features.length > 0, this._doesSelfIntersect ? this._hintline.setStyle({color: "red"}) : this._hintline.setStyle(this.options.hintlineStyle)
    }, _removeLastVertex: function () {
      var t = this._layer.getLatLngs(), e = t.pop();
      ...
      var n = new L.Marker(t, {draggable: !1, icon: L.divIcon({className: "marker-icon"})});
      return n._pmTempLayer = !0, this._layerGroup.addLayer(n), n.on("click", this._finishShape, this), e && this._hintMarker.setTooltipContent("单击以继续绘图"), 2 === this._layer.getLatLngs().length && this._hintMarker.setTooltipContent("Click any existing marker to finish"), n
    }
  })
}, function (t, e, n) {
  "use strict";
  ...
  r.a.Rectangle = r.a.extend({
    initialize: function (t) {
      ...
      }), this._startMarker._pmTempLayer = !0, this._layerGroup.addLayer(this._startMarker), this._hintMarker = L.marker([0, 0], {icon: L.divIcon({className: "marker-icon cursor-marker"})}), this._hintMarker._pmTempLayer = !0, this._layerGroup.addLayer(this._hintMarker), this.options.tooltips && this._hintMarker.bindTooltip("单击以放置第一个顶点", {
        permanent: !0,
        offset: L.point(0, 10),
        direction: "bottom",
        opacity: .8
      ...
      this._enabled && (this._enabled = !1, this._map._container.style.cursor = "", this._map.off("click", this._finishShape, this), this._map.off("click", this._placeStartingMarkers, this), this._map.off("mousemove", this._syncHintMarker, this), this._map.removeLayer(this._layerGroup), this._map.fire("pm:drawend", {shape: this._shape}), this._map.pm.Toolbar.toggleButton(this.toolbarButtonName, !1), this.options.snappable && this._cleanupSnapping())
    }, enabled: function () {
      return this._enabled
    }, toggle: function (t) {
      this.enabled() ? this.disable() : this.enable(t)
      ...
      }), this._map.off("click", this._placeStartingMarkers, this), this._map.on("click", this._finishShape, this), this._hintMarker.setTooltipContent("单击完成"), this._setRectangleOrigin()
      ...
      var t = this, e = this._startMarker.getLatLng(), n = this._hintMarker.getLatLng();
      ...
      var e = this._startMarker.getLatLng(), n = t.latlng,
        r = L.rectangle([e, n], this.options.pathOptions).addTo(this._map);
      this.disable(), this._map.fire("pm:create", {shape: this._shape, layer: r})
  ...
  r.a.Circle = r.a.extend({
    initialize: function (t) {
      ...
      this._enabled && (this._enabled = !1, this._map._container.style.cursor = "", this._map.off("click", this._finishShape, this), this._map.off("click", this._placeCenterMarker, this), this._map.off("mousemove", this._syncHintMarker, this), this._map.removeLayer(this._layerGroup), this._map.fire("pm:drawend", {shape: this._shape}), this._map.pm.Toolbar.toggleButton(this.toolbarButtonName, !1), this.options.snappable && this._cleanupSnapping())
    }, enabled: function () {
      return this._enabled
    }, toggle: function (t) {
      this.enabled() ? this.disable() : this.enable(t)
      ...
      var t = this._centerMarker.getLatLng(), e = this._hintMarker.getLatLng(), n = t.distanceTo(e);
      ...
      var t = this._centerMarker.getLatLng();
      t && (this._layer.setLatLng(t), this._hintMarker.on("move", this._syncHintLine, this), this._hintMarker.on("move", this._syncCircleRadius, this), this._hintMarker.setTooltipContent("单击以放置第一个顶点"), this._layer.fire("pm:centerplaced", {
        shape: this._shape,
        workingLayer: this._layer,
        latlng: t
      }))
    }, _finishShape: function (t) {
      var e = this._centerMarker.getLatLng(), n = t.latlng, r = e.distanceTo(n),
        i = Object.assign({}, this.options.pathOptions, {radius: r}), o = L.circle(e, i).addTo(this._map);
      this.disable(), this._map.fire("pm:create", {shape: this._shape, layer: o})
    }, _createMarker: function (t) {
  ...
  a.a.Cut = a.a.Poly.extend({
    initialize: function (t) {
      ...
      Object.keys(n).map(function (t) {
        ...
        var r = Object(o.a)(n.toGeoJSON(15), t.toGeoJSON(15)), i = L.geoJSON(r, n.options).addTo(e._map);
        i.addTo(e._map), i.pm.enable(e.options), i.pm.disable(), n.fire("pm:cut", {
          ...
          layer: i,
          originalLayer: n
        }), n._pmTempLayer = !0, t._pmTempLayer = !0, n.remove(), t.remove(), 0 === i.getLayers().length && e._map.pm.removeLayer({target: i})
      })
    }, _finishShape: function () {
      if (this.options.allowSelfIntersection || (this._handleSelfIntersection(!1), !this._doesSelfIntersect)) {
        var t = this._layer.getLatLngs(), e = L.polygon(t, this.options.pathOptions);
  ...
  e["default"] = function s(t, e, n) {
    ...
    if ("MultiPolygon" === r.type) {
      for (var p = [], f = 0, d = r.coordinates; f < d.length; f++) {
        var g = d[f], _ = s(o.getGeom(i.polygon(g)), l);
        if (_) {
          var m = o.getGeom(_);
  ...
  "use strict";
  var r = n(14), i = (n.n(r), n(34)), o = n.n(i), a = n(2), s = (n.n(a), n(13)), l = (n.n(s), n(15));
  n.n(l);
  ...
  e.a = function (t, e) {
    var n = Object(s.getGeom)(t), i = Object(s.getGeom)(e), o = t.properties || {};
  ...
  function a(t) {
    var e, n, r, o, a, l, h = 0, u = t.length;
    if (u > 2) {
  ...
  var r = {
    enableLayerDrag: function () {
      ...
      var t = this, e = this._layer._path ? this._layer._path : this._layer._renderer._container;
      return this._originalMapDragState && this._layer._map.dragging.enable(), this._safeToCacheDragState = !0, this._layer._map.off("mousemove", this._dragMixinOnMouseMove, this), this._layer.off("mouseup", this._dragMixinOnMouseUp, this), !!this._dragging && (window.setTimeout(function () {
      ...
      var e = t.latlng, n = e.lat - this._tempDragCoord.lat, r = e.lng - this._tempDragCoord.lng;
      if (this._layer instanceof L.CircleMarker) {
        var i = function (t) {
          return {lat: t.lat + n, lng: t.lng + r}
        }(this._layer.getLatLng());
        this._layer.setLatLng(i).redraw()
      } else {
        var o = function t(e) {
          return e.map(function (e) {
            return Array.isArray(e) ? t(e) : {lat: e.lat + n, lng: e.lng + r}
          })
        }(this._layer.getLatLngs());
        this._layer.setLatLngs(o).redraw()
      }
      this._tempDragCoord = e, this._layer.fire("pm:drag")
    }
  };
  e.a = r
}, function (t, e, n) {
  ...
  "use strict";
  var r = n(12), i = n.n(r), o = n(39), a = n.n(o), s = n(1), l = n(11);
  s.a.Line = s.a.extend({
    initialize: function (t) {
      ...
      var e = this, n = this._layer;
      if (this.hasSelfIntersection()) {
        if (this.isRed) return;
        t ? (n.setStyle({color: "red"}), this.isRed = !0, window.setTimeout(function () {
          n.setStyle({color: e.cachedColor}), e.isRed = !1
        }, 200)) : (n.setStyle({color: "red"}), this.isRed = !0), this._layer.fire("pm:intersect", {intersection: i()(this._layer.toGeoJSON(15))})
      } else n.setStyle({color: this.cachedColor}), this.isRed = !1
    }, _initMarkers: function () {
      var t = this, e = this._map, n = this._layer.getLatLngs();
      ...
      var n = this;
      if (!t || !e) return !1;
      var r = l.a.calcMiddleLatLng(this._map, t.getLatLng(), e.getLatLng()), i = this._createMarker(r),
      ...
      var r = t.getLatLng(), i = this._layer._latlngs, o = this.findDeepMarkerIndex(this._markers, e), s = o.indexPath,
        l = o.index, h = o.parentPath, u = s.length > 1 ? a()(i, h) : i,
      ...
      var n = t.target, r = this._layer.getLatLngs(), i = this.findDeepMarkerIndex(this._markers, n), o = i.indexPath,
        s = i.index, l = i.parentPath;
      if (o) {
        var h, u, c = o.length > 1 ? a()(r, l) : r, p = o.length > 1 ? a()(this._markers, l) : this._markers;
      ...
      var r = {};
      return n && (r = {indexPath: n, index: n[n.length - 1], parentPath: n.slice(0, n.length - 1)}), r
    }, updatePolygonCoordsFromMarkerDrag: function (t) {
      var e = this._layer.getLatLngs(), n = t.getLatLng(), r = this.findDeepMarkerIndex(this._markers, t),
        i = r.indexPath, o = r.index, s = r.parentPath;
      (i.length > 1 ? a()(e, s) : e).splice(o, 1, n), this._layer.setLatLngs(e).redraw()
    }, _onMarkerDrag: function (t) {
      var e = t.target, n = this.findDeepMarkerIndex(this._markers, e), r = n.indexPath, i = n.index, o = n.parentPath;
      if (r) {
        this.updatePolygonCoordsFromMarkerDrag(e);
        var s = r.length > 1 ? a()(this._markers, o) : this._markers, h = (i + 1) % s.length,
          u = (i + (s.length - 1)) % s.length, c = e.getLatLng(), p = s[u].getLatLng(), f = s[h].getLatLng();
      ...
      var e = t.target, n = this.findDeepMarkerIndex(this._markers, e).indexPath;
      ...
      this._layer.fire("pm:markerdragend", {markerEvent: t, indexPath: n}), this._fireEdit()
  ...
  var r = n(6), i = n(42), o = n(48), a = n(78);
  t.exports = function (t, e) {
    return r(t) ? t : i(t, e) ? [t] : o(a(t))
  }
}, function (t, e, n) {
  var r = n(6), i = n(7), o = /\.|\[(?:[^[\]]*|(["'])(?:(?!\1)[^\\]|\\.)*?\1)\]/, a = /^\w*$/;
  t.exports = function (t, e) {
    if (r(t)) return !1;
    var n = typeof t;
  ...
  var r = n(8), i = Object.prototype, o = i.hasOwnProperty, a = i.toString, s = r ? r.toStringTag : undefined;
  t.exports = function (t) {
  ...
  var r = n(52), i = n(73), o = n(75), a = n(76), s = n(77);
  ...
  var r = n(53), i = n(65), o = n(72);
  t.exports = function () {
    this.size = 0, this.__data__ = {hash: new r, map: new (o || i), string: new r}
  }
}, function (t, e, n) {
  var r = n(54), i = n(61), o = n(62), a = n(63), s = n(64);
  ...
  var r = n(56), i = n(57), o = n(18), a = n(59), s = /^\[object .+?Constructor\]$/, l = Function.prototype,
    h = Object.prototype, u = l.toString, c = h.hasOwnProperty,
    p = RegExp("^" + u.call(c).replace(/[\\^$.*+?()[\]{}|]/g, "\\$&").replace(/hasOwnProperty|(function).*?(?=\\\()| for .+?(?=\\\])/g, "$1.*?") + "$");
  t.exports = function (t) {
    return !(!o(t) || i(t)) && (r(t) ? p : s).test(a(t))
  }
}, function (t, e, n) {
  var r = n(16), i = n(18), o = "[object AsyncFunction]", a = "[object Function]", s = "[object GeneratorFunction]",
    l = "[object Proxy]";
  t.exports = function (t) {
    if (!i(t)) return !1;
    var e = r(t);
  ...
  var r = n(3), i = "__lodash_hash_undefined__", o = Object.prototype.hasOwnProperty;
  t.exports = function (t) {
    var e = this.__data__;
    if (r) {
      var n = e[t];
  ...
  var r = n(3), i = "__lodash_hash_undefined__";
  t.exports = function (t, e) {
    var n = this.__data__;
    return this.size += this.has(t) ? 0 : 1, n[t] = r && e === undefined ? i : e, this
  }
}, function (t, e, n) {
  var r = n(66), i = n(67), o = n(69), a = n(70), s = n(71);
  ...
  var r = n(4), i = Array.prototype.splice;
  t.exports = function (t) {
  ...
  var r = n(8), i = n(80), o = n(6), a = n(7), s = 1 / 0, l = r ? r.prototype : undefined,
  ...
  r.a.Rectangle = r.a.Poly.extend({
    _initMarkers: function () {
      var t = this._map, e = this._findCorners();
      ...
      var n = new L.Marker(t, {draggable: !0, icon: L.divIcon({className: "marker-icon"})});
      ...
      var e = t.target, n = this._findCorners();
      e._oppositeCornerLatLng = n[(e._index + 2) % 4], e._snapped = !1, this._layer.fire("pm:markerdragstart", {markerEvent: t})
    }, _onMarkerDrag: function (t) {
      var e = t.target;
      ...
      }), this._layer.setLatLngs(e), this._layer.redraw(), this._layer.fire("pm:markerdragend", {markerEvent: t}), this._fireEdit()
      ...
      if (t && t.getLatLng && t._oppositeCornerLatLng) {
        var e = t.getLatLng(), n = t._oppositeCornerLatLng, r = [];
  ...
  r.a.Circle = r.a.extend({
    initialize: function (t) {
      ...
      var e = this._layer.getLatLng(), n = this._layer._radius, r = this._getLatLngOnCircle(e, n);
      ...
      var n = this._map.project(t), r = L.point(n.x + e, n.y);
      ...
      var n = this._layer._radius, r = this._getLatLngOnCircle(e, n);
      ...
      this._fireEdit(), this._layer.fire("pm:markerdragend", {markerEvent: t})
    }, _syncCircleRadius: function () {
      var t = this._centerMarker.getLatLng(), e = this._outerMarker.getLatLng(), n = t.distanceTo(e);
      this._layer.setRadius(n)
    }, _syncHintLine: function () {
      ...
      var n = t.getLatLng(), r = e.getLatLng();
