...
<el-tree
  ...
  <div>
     <div class="filter-container">
      <el-input @keyup.enter.native="handleDictValueFilter" style="width: 200px;position:relative;top:2px;" class="filter-item" placeholder="编码" v-model="listDictValueQuery.labelDefault"> </el-input>
      <el-button class="filter-item" type="primary" icon="search" @click="handleDictValueFilter">搜索</el-button>
      <el-button class="filter-item" style="margin-left: 10px;" @click="handleDictValueCreate" type="primary" v-if="this.dictValueManager_btn_add">创建</el-button>
    </div>
